...
const AiChat = () => {
  const initialMessages = [
    ...
    { role: "ai", text: "I am doing great, thanks." },
    { role: "user", text: "What is the meaning of life?" },
    { role: "ai", text: "Seeking fulfillment and personal growth." },
  ];
