  ...
  try {
    ...
    if (result.length > 0) {
      ...
      for (const comment of result) {
        ...
        switch (comment.type) {
          case "Lab Report":
            messageObject.message = "A new lab report comment has been added.";
            break;
          case "Prescription":
            messageObject.message =
              "A new prescription comment has been added.";
            break;
          case "Requisition":
            messageObject.message = "A new requisition comment has been added.";
            break;
          case "Diet Diary":
            messageObject.message = "A new diet comment has been added.";
            break;
